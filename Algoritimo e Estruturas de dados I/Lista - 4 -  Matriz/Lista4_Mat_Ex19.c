...
int mat[3][3], mat1[3][3], i, j, i2, j2;
...
printf("Matriz 2:\n");
	...
	mat[0][2] = mat[0][2] + mat1[0][2];
	mat[1][0] = mat[1][0] + mat1[1][0];
	mat[1][1] = mat[1][1] + mat1[1][1];
	mat[1][2] = mat[1][2] + mat1[1][2];
	mat[2][0] = mat[2][0] + mat1[2][0];
	mat[2][1] = mat[2][1] + mat1[2][1];
	mat[2][2] = mat[2][2] + mat1[2][2];
